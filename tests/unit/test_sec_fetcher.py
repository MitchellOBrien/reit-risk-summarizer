...
class TestSECFetcher:
    ...
    def test_retry_on_timeout(self, mock_get, mock_settings):
        ...
        mock_get.side_effect = [Timeout("Read timed out"), Timeout("Read timed out"), mock_response]
    ...
    def test_retry_on_503(self, mock_get, mock_settings):
        ...
        mock_get.side_effect = [create_503_error(), create_503_error(), success_response]
