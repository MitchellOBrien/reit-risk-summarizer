...
class RiskFactorExtractor:
    ...
    def __init__(
        self, min_length: int = 10_000, warn_threshold: int = 30_000, raise_on_short: bool = True
    ):
    ...
    def extract_risk_factors(self, html: str) -> str:
        ...
        risk_text = (
            self._extract_by_item_header(soup)
            or self._extract_by_table_of_contents(soup)
            or self._extract_by_pattern_matching(html)
        )
    ...
    def _extract_by_item_header(self, soup: BeautifulSoup) -> str | None:
    ...
    def _extract_by_table_of_contents(self, soup: BeautifulSoup) -> str | None:
    ...
    def _extract_by_pattern_matching(self, html: str) -> str | None:
