...
def main():
    ...
    group.add_argument(
        "--ticker",
        type=str,
        help="Evaluate a single ticker (e.g., PLD)"
    )
    group.add_argument(
        "--all",
        action="store_true",
        help="Evaluate all tickers in golden dataset"
    )
    group.add_argument(
        "--sector",
        type=str,
        help="Evaluate all tickers in a specific sector (e.g., industrial)"
    )
    ...
    if args.ticker:
        ...
        tickers = [
            ticker for ticker, record in evaluator.golden_records.items()
