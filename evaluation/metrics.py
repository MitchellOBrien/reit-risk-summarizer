...
def calculate_ndcg_at_k(
    ...
    relevance_scores = [
        1.0 if risk in golden_risks else 0.0 
...
DEFAULT_SECTOR_KEYWORDS = {
    "industrial": [
        "logistics", "warehouse", "distribution", "e-commerce", 
        "supply chain", "tenant demand", "lease renewal", "occupancy"
    ],
    "healthcare": [
        "medical", "hospital", "senior housing", "skilled nursing",
        "healthcare operators", "regulatory", "reimbursement", "Medicare"
    ],
    "retail": [
        "retail", "shopping center", "mall", "anchor tenant",
        "consumer spending", "online competition", "foot traffic"
    ],
    "residential": [
        "apartment", "multifamily", "rental", "tenant", "occupancy",
        "rent growth", "housing market", "residential property"
    ],
    "office": [
        "office", "tenant", "lease", "occupancy", "workplace",
        "remote work", "commercial real estate", "corporate demand"
    ],
    "data_center": [
        "data center", "cloud", "connectivity", "power", "cooling",
        "hyperscale", "colocation", "bandwidth", "uptime"
    ]
}
...
def evaluate_summary(
    ...
    return {
        ...
        "ndcg_at_5": calculate_ndcg_at_k(
            generated_risks, golden_risks, k=5
        ),
